...
import com.hkllzh.androiddemoapp.util.ACache;
import com.hkllzh.androiddemoapp.util.LogUtil;
import com.hkllzh.androiddemoapp.util.MD5Util;
 ...
 * 以后在此基础上还可以增加日志记录功能
 * <p/>
 * 可以支持get请求的本地缓存，默认缓存时间为{@link com.hkllzh.androiddemoapp.net.NetRequest#DEFAULT_CACHE_TIME}
 * <p/>
 * <b>使用：</b>
 * <p/>
 * 在{@link android.app.Activity#onCreate(android.os.Bundle)}生成实例，
 * 随后直接调用相应的{@link com.hkllzh.androiddemoapp.net.NetRequest#get(String, com.loopj.android.http.RequestParams, RequestHandler)}
 * 或者{@link com.hkllzh.androiddemoapp.net.NetRequest#post(String, com.loopj.android.http.RequestParams, RequestHandler)}方法即可
 * <p/>
 * <p/>
 * <p/>
 * lizheng -- 15/1/11
